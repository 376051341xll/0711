...
describe('practice2', function()  {
    ...
    it('I am Tom. I know Jerry has joined Class 2.', function() {
        let answer="I am Tom. I know Jerry has joined Class 2.";
        let classes =[];
        let klass1=new Klass(2); classes.push(klass1);
        let klass2=new Klass(3);classes.push(klass2);
        let Jerry=new Student(2010,'Jerry',21,klass1);
        let Tom=new Teacher(2011,'Tom',21,classes);
        let result;
        if(Tom.isTeaching(Jerry)){
            result= Tom.informJoin(klass1,Jerry);
        }
        expect(Tom.informJoin(klass1,Jerry)).toEqual(answer);

    });

    it('I am Tom. I know Jerry become Leader of Class 2.', function() {
        let answer="I am Tom. I know Jerry become leader of Class 2.";
        let classes =[];
        let klass1=new Klass(2); classes.push(klass1);
        let klass2=new Klass(3);classes.push(klass2);
        let Jerry=new Student(2010,'Jerry',21,klass1);
        let Tom=new Teacher(2011,'Tom',21,classes);
        let result;
        if(Tom.isLeader(Jerry)){
           result= Tom.informLeader(klass1,Jerry);
        }
        expect(Tom.informLeader(klass1,Jerry)).toEqual(answer);
